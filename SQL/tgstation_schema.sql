...
-- -----------------------------------------------------
-- Table `tgstation`.`harpy`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `tgstation`.`harpy` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `spendername` TEXT NOT NULL ,
  `spenderkey` TEXT NOT NULL ,
  `receivername` TEXT NOT NULL ,
...
-- -----------------------------------------------------
-- Table `tgstation`.`harpytotals`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `tgstation`.`harpytotals` (
  `id` INT(11) NOT NULL AUTO_INCREMENT ,
  `byondkey` TEXT NOT NULL ,
  `harpy` INT(11) NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = MyISAM
AUTO_INCREMENT = 244
DEFAULT CHARACTER SET = latin1;
