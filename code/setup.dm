...
#define	HUNGER_FACTOR 0.2 //0.4 ?
#define	REAGENTS_METABOLISM 0.2
#define REAGENTS_OVERDOSE 50
...
#define SPACE_HEAT_TRANSFER_COEFFICIENT 0.08 //a hack to partly simulate radiative heat
#define OPEN_HEAT_TRANSFER_COEFFICIENT 0.08
...
#define T0C 273.15				//273.15	// 0degC
#define T20C 293.15					// 20degC
#define TCMB 293.15				//2.7	// -270.3degC
...
#define MAX_STACK_AMOUNT_METAL	20
#define MAX_STACK_AMOUNT_GLASS	20
#define MAX_STACK_AMOUNT_RODS	20
...
var/list/accessable_z_levels = list("1" = 50, "2" = 50, "3" = 0)
...
var/static/list/scarySounds = list('thudswoosh.ogg','sound/weapons/Taser.ogg','armbomb.ogg','hiss1.ogg','hiss2.ogg','hiss3.ogg','hiss4.ogg','hiss5.ogg','hiss6.ogg','Glassbr1.ogg','Glassbr2.ogg','Glassbr3.ogg','Welder.ogg','Welder2.ogg','airlock.ogg','clownstep1.ogg','clownstep2.ogg')
