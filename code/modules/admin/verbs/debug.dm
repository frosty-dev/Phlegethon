...
*/
		...
		if("miner commando")
			...
			M.equip_if_possible(new /obj/item/clothing/under/rank/unit_d(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/suit/space/minercoat(M), M.slot_wear_suit)
			M.equip_if_possible(new /obj/item/clothing/shoes/combat(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/clothing/gloves/combat(M), M.slot_gloves)
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/clothing/head/helmet/space/minerplate(M), M.slot_head)
			M.equip_if_possible(new /obj/item/weapon/gun/projectile/handy(M), M.slot_belt)
			M.equip_if_possible(new /obj/item/weapon/hatchet(M), M.slot_r_store)
			M.equip_if_possible(new /obj/item/ammo_magazine/c22_tommy_mag(M), M.slot_l_store)
			M.equip_if_possible(new /obj/item/weapon/storage/backpack/haversack(M), M.slot_back)
			M.equip_if_possible(new /obj/item/weapon/gun/projectile/automatic/tommy(M), M.slot_r_hand)
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Miner Commando Officer"
			W.registered_name = M.real_name
			M.equip_if_possible(W, M.slot_wear_id)

		if("miner infantry")
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/clothing/under/marw(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/suit/storage/fieldjacket(M), M.slot_wear_suit)
			M.equip_if_possible(new /obj/item/clothing/shoes/fullbrown(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/clothing/head/helmet/mone(M), M.slot_head)
			M.equip_if_possible(new /obj/item/weapon/storage/belt/garandbelt/full(M), M.slot_belt)
			M.equip_if_possible(new /obj/item/weapon/storage/backpack/haversack(M), M.slot_back)
			M.equip_if_possible(new /obj/item/weapon/gun/projectile/garand(M), M.slot_r_hand)
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Miner Infantry Regular"
			W.registered_name = M.real_name
			M.equip_if_possible(W, M.slot_wear_id)

		if("arcology combat")
			M.equip_if_possible(new /obj/item/clothing/mask/gas(M), M.slot_wear_mask)
			M.equip_if_possible(new /obj/item/clothing/under/tac(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/suit/armor/vestd(M), M.slot_wear_suit)
			M.equip_if_possible(new /obj/item/clothing/shoes/db(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/clothing/head/helmet/pasgt(M), M.slot_head)
			M.equip_if_possible(new /obj/item/weapon/gun/projectile/automatic/hamlet(M), M.slot_belt)
			M.equip_if_possible(new /obj/item/ammo_magazine/c45s_hamlet_mag(M), M.slot_l_store)
			M.equip_if_possible(new /obj/item/stack/medical/advanced/bruise_pack(M), M.slot_r_store)
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Arcology Infantry Regiment"
			W.registered_name = M.real_name
			M.equip_if_possible(W, M.slot_wear_id)

		if("arcology camp")
			M.equip_if_possible(new /obj/item/clothing/under/acu(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/shoes/db(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/weapon/storage/belt/gunslinger/full(M), M.slot_belt)
		...
		if("metropolis police")
			M.equip_if_possible(new /obj/item/clothing/under/patrol(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/suit/storage/patrols(M), M.slot_wear_suit)
			M.equip_if_possible(new /obj/item/clothing/shoes/jackboots(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/weapon/storage/belt/security/metropolis(M), M.slot_belt)
			M.equip_if_possible(new /obj/item/clothing/head/det_hat/fluff/retpolcap(M), M.slot_head)
			M.equip_if_possible(new /obj/item/ammo_magazine/c9mm_smithw_mag(M), M.slot_l_store)
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Metropolis Police"
			W.registered_name = M.real_name
			M.equip_if_possible(W, M.slot_wear_id)

		if("main force patrol")
			M.equip_if_possible(new /obj/item/clothing/under/madmax(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/suit/storage/madmaxs(M), M.slot_wear_suit)
			M.equip_if_possible(new /obj/item/clothing/shoes/fluff/leatherboots(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/weapon/storage/belt/gunslinger/full(M), M.slot_belt)
			M.equip_if_possible(new /obj/item/clothing/head/helmet/motohelm(M), M.slot_head)
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Main Force Patrol"
			W.registered_name = M.real_name
			M.equip_if_possible(W, M.slot_wear_id)
		...
		if("arcology agent")
			...
			M.equip_if_possible(new /obj/item/clothing/shoes/fullbrown(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/clothing/head/det_hat_bl(M), M.slot_head)
			M.equip_if_possible(new /obj/item/weapon/storage/backpack/satchel(M), M.slot_back)
			M.equip_if_possible(new /obj/item/weapon/gun/projectile/sleuthds(M), M.slot_r_store)
			M.equip_if_possible(new /obj/item/ammo_magazine/c38s/ex(M), M.slot_l_store)
			M.equip_if_possible(new /obj/item/weapon/cigpacket/yiheyuan(M), M.slot_s_store)
			...
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "Metropolis Special Agent"
			W.registered_name = M.real_name
			M.equip_if_possible(W, M.slot_wear_id)
		...
		if("gunslinger")
			...
			M.equip_if_possible(new uniform(M), M.slot_w_uniform)
			M.equip_if_possible(new suit(M), M.slot_wear_suit)
			M.equip_if_possible(new shoes(M), M.slot_shoes)
			M.equip_if_possible(new hat(M), M.slot_head)
			M.equip_if_possible(new /obj/item/weapon/storage/backpack/satchel(M), M.slot_back)
			M.equip_if_possible(new /obj/item/weapon/storage/belt/gunslinger/full(M), M.slot_belt)
			M.equip_if_possible(new /obj/item/weapon/gun/projectile/canis(M), M.slot_s_store)
			M.equip_if_possible(new /obj/item/clothing/gloves/glinger(M), M.slot_gloves)
			M.equip_if_possible(new /obj/item/clothing/mask/bluescarf(M), M.slot_l_store)
			M.equip_if_possible(new /obj/item/weapon/reagent_containers/food/drinks/dflask(M), M.slot_r_store)
...
//phleg
		...
		if("inspector")
			M.equip_if_possible(new /obj/item/clothing/under/syndicate/combat(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/suit/space/space_inspector(M), M.slot_wear_suit)
			M.equip_if_possible(new /obj/item/clothing/shoes/combat(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/clothing/gloves/combat(M), M.slot_gloves)
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/clothing/glasses/senglasses(M), M.slot_glasses)
			M.equip_if_possible(new /obj/item/clothing/mask/gas/plaguedoctor(M), M.slot_wear_mask)
			M.equip_if_possible(new /obj/item/clothing/head/helmet/inspector(M), M.slot_head)
			...
			M.equip_if_possible(new /obj/item/weapon/storage/backpack/holding/inspector(M), M.slot_back)
		...
		if("agent 1")
			M.equip_if_possible(new /obj/item/clothing/under/syndicate/combat(M), M.slot_w_uniform)
			M.equip_if_possible(new /obj/item/clothing/suit/space/bodyguard(M), M.slot_wear_suit)
			M.equip_if_possible(new /obj/item/clothing/shoes/combat(M), M.slot_shoes)
			M.equip_if_possible(new /obj/item/clothing/gloves/combat(M), M.slot_gloves)
			M.equip_if_possible(new /obj/item/device/radio/headset/heads/captain(M), M.slot_ears)
			M.equip_if_possible(new /obj/item/clothing/glasses/senglasses(M), M.slot_glasses)
			...
			M.equip_if_possible(new /obj/item/weapon/storage/belt/utility/fvll(M), M.slot_belt)
			M.equip_if_possible(new /obj/item/weapon/pepperspray/elited(M), M.slot_r_store)
			M.equip_if_possible(new /obj/item/weapon/flashbang/clusterbang(M), M.slot_l_store)
			M.equip_if_possible(new /obj/item/weapon/storage/backpack/holding/agent1(M), M.slot_back)
