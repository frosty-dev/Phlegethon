...
//phlegTG
/*	//phlegfov
	mymob.fovoverlay = new /obj/screen()
	mymob.fovoverlay.icon = 'icons/mob/screen_full.dmi'
//	mymob.fovoverlay.icon_state = "fov"
	mymob.fovoverlay.name = "fov"
	mymob.fovoverlay.screen_loc = "1,1"
	mymob.fovoverlay.mouse_opacity = 0
	mymob.fovoverlay.layer = 17.9 //The black screen overlay sets layer to 18 to display it, this one has to be just on top.
*/
//phlegfov
...
*/
	...
	mymob.client.screen += list( mymob.pain, mymob.throw_icon, mymob.zone_sel, mymob.oxygen, mymob.pressure, mymob.toxin, mymob.bodytemp, mymob.internals, mymob.fire, mymob.healths, mymob.nutrition_icon, mymob.pullin, mymob.blind, mymob.flash, mymob.damageoverlay)//, mymob.fovoverlay) //, mymob.hands, mymob.rest, mymob.sleep, mymob.gun_setting_icon) //, mymob.mach )
