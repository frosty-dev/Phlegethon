		...
		if(G.cell)
			if(M.a_intent == "hurt")//Stungloves. Any contact will stun the alien.
				if(G.cell.charge >= 2500)
					...
					message_admins("ATTACK: [src] ([src.ckey])(<a href=\"byond://?src=%admin_ref%;teleto=\ref[src]\">Jump</a>) stungloved [M] ([M.ckey]).")
...
//			if(M.health < -75)	return 0
		...
		if("hurt")
			...
			if(M.type != /mob/living/carbon/human/tajaran)
				...
				message_admins("ATTACK: [M] ([M.ckey])(<a href=\"byond://?src=%admin_ref%;teleto=\ref[M]\">Jump</a>) punched [src] ([src.ckey]).")
				...
				message_admins("ATTACK: [M] ([M.ckey])(<a href=\"byond://?src=%admin_ref%;teleto=\ref[M]\">Jump</a>) slashed [src] ([src.ckey]).")
