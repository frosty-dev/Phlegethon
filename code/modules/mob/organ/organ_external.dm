...
//	if (brainmob.client) phleg no head
//		spawn(10)
	//		if(brainmob.client)
	...
	if(istype(W,/obj/item/weapon/scalpel))
		...
		switch(brain_op_stage)
			...
			if(3)
				...
				message_admins("ATTACK: [brainmob] ([brainmob.ckey])(<a href=\"byond://?src=%admin_ref%;teleto=\ref[brainmob]\">Jump</a>) debrained [user] ([user.ckey]).")
...
obj/item/weapon/organ/attackby(obj/item/weapon/W as obj, mob/user as mob)
	..()
	if (is_cut(W))
		usr << "\blue You cut the [src]."
		sleep(40)
		new /obj/item/weapon/reagent_containers/food/snacks/sliceable/meat(user.loc)
		del(src)
