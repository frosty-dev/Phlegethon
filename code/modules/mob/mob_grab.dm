...
/obj/item/weapon/grab/proc/fbyond_throw()
	if(affecting)
...
*/
					...
					if (state >= 3)
						...
						if (killing)
							...
							message_admins("ATTACK: [assailant] ([assailant.ckey])(<a href=\"byond://?src=%admin_ref%;teleto=\ref[assailant]\">Jump</a>) strangled [affecting] ([affecting.ckey]).")
