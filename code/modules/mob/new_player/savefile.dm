...
datum/preferences/proc/savefile_save(mob/user, slot)
	...
	//Job data
	F["job_TH_high"] << src.job_TH_high
	F["job_TH_med"] << src.job_TH_med
	F["job_TH_low"] << src.job_TH_low

	F["job_TH_high"] << src.job_TH_high
	F["job_TH_med"] << src.job_TH_med
	F["job_TH_low"] << src.job_TH_low

	F["job_MMC_high"] << src.job_MMC_high
	F["job_MMC_med"] << src.job_MMC_med
	F["job_MMC_low"] << src.job_MMC_low
