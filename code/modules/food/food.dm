...
/obj/item/weapon/reagent_containers/food/snacks/shrimpmeat
	name = "shrimp meat"
	desc = "A nutritious shrimp meat."
	icon_state = "fishfillet"
	New()
		..()
		reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/burger/xeno
	...
	New()
		...
		reagents.add_reagent("xenomicrobes", 7)
...
/obj/item/weapon/reagent_containers/food/snacks/canbeans
	name = "Jung`s Beans"
	icon_state = "canbeans"
	desc = "Can of tasty beans in tomato sause."
	trash = "canbeans"
	New()
		..()
		reagents.add_reagent("nutriment", 10)
...
/obj/item/weapon/reagent_containers/food/snacks/canfruit
	name = "Tropical Fruits"
	icon_state = "canfruit"
	desc = "Can of tasty fruits in coconut milk."
	trash = "canfruit"
	New()
		..()
		reagents.add_reagent("nutriment", 8)
...
/obj/item/weapon/reagent_containers/food/snacks/cangator
	name = "Gator slices"
	icon_state = "cangator"
	desc = "Can of delicious alligator meat. Can has bullet inside as bonus!"
	trash = "cangator"
	New()
		..()
		reagents.add_reagent("nutriment", 12)
...
/obj/item/weapon/reagent_containers/food/snacks/canmre
	name = "C-ration"
	icon_state = "canmre"
	desc = "Can of meat with vegetables."
	trash = "canmre"
	New()
		..()
		reagents.add_reagent("nutriment", 12)
...
/obj/item/weapon/reagent_containers/food/snacks/bananaphone
	name = "Bananaphone"
	desc = "Ring, ring, ring! Bananaphone!"
	...
	New()
		...
		reagents.add_reagent("spacedrugs", 5)