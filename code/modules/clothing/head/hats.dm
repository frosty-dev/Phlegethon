...
/obj/item/clothing/head/hosberet
	name = "beret with golden insignia"
	desc = "Head of Security's beret."
	icon_state = "hos_beret"
	flags = FPRINT | TABLEPASS

/obj/item/clothing/head/csoberet
	name = "beret with red/blue insignia"
	desc = "Chief Security Officer's beret."
	icon_state = "cso_beret"
	flags = FPRINT | TABLEPASS

/obj/item/clothing/head/soberet
	name = "beret with red insignia"
	desc = "Security Officer's beret."
	icon_state = "so_beret"
	flags = FPRINT | TABLEPASS