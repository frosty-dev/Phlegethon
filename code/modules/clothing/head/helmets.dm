...
//phleg
/obj/item/clothing/head/helmet/mone
	name = "M1 helmet"
	desc = "As old as the hills protective M1 helmet."
	icon_state = "mone"
	flags = FPRINT | TABLEPASS | SUITSPACE | HEADCOVERSEYES
	item_state = "helmet"
	armor = list(melee = 50, bullet = 70, laser = 0,energy = 20, bomb = 40, bio = 0, rad = 0)
	protective_temperature = 500
	heat_transfer_coefficient = 0.10
	flags_inv = HIDEEARS|HIDEEYES
...
/obj/item/clothing/head/helmet/pasgt
	name = "PASGT Desert"
	desc = "Retro combat helmet."
	icon_state = "pasgt"
	flags = FPRINT | TABLEPASS | SUITSPACE | HEADCOVERSEYES
	item_state = "helmet"
	armor = list(melee = 60, bullet = 90, laser = 0,energy = 20, bomb = 40, bio = 0, rad = 0)
	protective_temperature = 500
	heat_transfer_coefficient = 0.10
	flags_inv = HIDEEARS|HIDEEYES

/obj/item/clothing/head/helmet/motohelm
	name = "Moto helmet"
	desc = "Metropolis State Highway Patrol helmet."
	icon_state = "motohelm"
	flags = FPRINT | TABLEPASS | SUITSPACE | HEADCOVERSEYES
	item_state = "helmet"
	armor = list(melee = 60, bullet = 50, laser = 0,energy = 20, bomb = 20, bio = 0, rad = 0)
	protective_temperature = 500
	heat_transfer_coefficient = 0.10
	flags_inv = HIDEEARS|HIDEEYES
