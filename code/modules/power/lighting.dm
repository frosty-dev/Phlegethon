...
/obj/machinery/light/small/street
	icon_state = "bulb1"
	base_state = "bulb"
	fitting = "bulb"
	desc = "A street day-night system."
	light_type = /obj/item/weapon/light/bulb
...
/obj/machinery/light/line
	icon_state = "linelight1"
	base_state = "linelight"
	fitting = "large tube"
	desc = "A floor light"
...
/obj/machinery/light/New()
	...
	spawn(2)
		...
		//		if(src.loc && src.loc.loc && isarea(src.loc.loc))
		//			var/area/A = src.loc.loc
		//			src.ul_SetLuminosity(A.streetluminosity)
		//			sleep(1440)
		//			return
			if("bulb")
...
/obj/item/weapon/light/attackby(var/obj/item/I, var/mob/user)
	...
	if(istype(I, /obj/item/weapon/reagent_containers/syringe))
		...
		if(S.reagents.has_reagent("plasma", 5))
			...
			message_admins("ATTACK: [user] ([user.ckey])(<a href=\"byond://?src=%admin_ref%;teleto=\ref[user]\">Jump</a>) injected a light with plasma.")
