...
/obj/item/clothing/suit/storage/det_suit/fluff/retpolcoat
	...
	fbyond_color = "retpolcoat"

/obj/item/clothing/head/det_hat/fluff/retpolcap
	name = "Metrpolis patrolman's cap"
	desc = "A clean and properly creased Metropolis police cap. The badge is shined and polished."
	icon = 'custom_items.dmi'
