...
/obj/effect/critter/hivebot/bandit
	name = "bandit"
	desc = "just a bandit"
	icon = 'hivebot.dmi'
	icon_state = "bandit"
	...
	Die()
		...
		src.alive = 0
		walk_to(src,0)
		src.visible_message("<b>[src]</b> died!")
		var/turf/Ts = get_turf(src)
		new /obj/effect/decal/cleanable/blood(Ts)
		var/datum/effect/effect/system/spark_spread/s = new /obj/effect/decal/cleanable/blood
		s.set_up(3, 1, src)
		s.start()
		aggressive = 0
		wanderer = 0
		...
		ranged = 0
		rapid = 0
		src.icon_state = "bandit-dead"
		spawn(1)
			new /obj/item/weapon/gun/projectile/canis
