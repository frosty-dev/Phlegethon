...
/obj/item/weapon/storage/backpack/haversack
	name = "haversack"
	desc = "It's a strong raid haversack"
...
//Spawns with 2 glass, 2 metal, 1 steel, and 2 special boxes.
	New()
		...
		B2.w_class = 2
		var/fbyond_color = pick("red","yellow","green","blue")
		for(var/i = 1, i <= 7, i++)
			if(i < 4)
				var/obj/item/weapon/cable_coil/P = new /obj/item/weapon/cable_coil(B2,30,fbyond_color)
				P.loc = B2
			if(i >= 4)
...
/obj/item/weapon/storage/wallet
	name = "wallet"
	desc = "It can hold a few small and personal things like vitacoins."
	storage_slots = 6
	icon_state = "wallet"
	w_class = 2
	can_hold = list(
