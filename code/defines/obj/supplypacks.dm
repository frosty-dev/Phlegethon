...
/datum/supply_packs/combatammo			//phleg
	name = "Combat shells"
	...
	cost = 40
	containertype = "/obj/structure/closet/crate"
	containername = "Combat shells"
	group = "Security"


/datum/supply_packs/fraggrenades			//phleg
	name = "Frag Nanobots Grenades"
	contains = list("/obj/item/weapon/fragbomb",
	...
	cost = 60
	containertype = "/obj/structure/closet/crate"
	containername = "Frag Nanobots Grenades"
	group = "Security"

/datum/supply_packs/fraggrenadesmk			//phleg
	name = "Frag Grenades MK2A7"
	contains = list("/obj/item/weapon/fragmk",
					"/obj/item/weapon/fragmk",
					"/obj/item/weapon/fragmk",
					"/obj/item/weapon/fragmk")
	cost = 70
	containertype = "/obj/structure/closet/crate"
	containername = "Frag Grenades MK2A7"
	group = "Security"


/datum/supply_packs/leadammo
	name = "Lead shells"
	contains = list("/obj/item/ammo_casing/shotgun/lead",
	...
	cost = 40
	containertype = "/obj/structure/closet/crate"
	containername = "Lead shells"
	group = "Security"


/datum/supply_packs/c45sammo
	name = ".45 special ammo"
	contains = list("/obj/item/ammo_magazine/ammobox/c45s",
					"/obj/item/ammo_magazine/ammobox/c45s",
					"/obj/item/ammo_magazine/c45s_handy_mag/empty",
					"/obj/item/ammo_magazine/c45s_hamlet_mag/empty")
	cost = 40
	containertype = "/obj/structure/closet/crate"
	containername = ".45 special ammo"
	group = "Security"


/datum/supply_packs/c38sammo
	name = ".38 special speedloader"
	contains = list("/obj/item/ammo_magazine/c38s",
					"/obj/item/ammo_magazine/ammobox/c38s")
	cost = 40
	containertype = "/obj/structure/closet/crate"
	containername = ".38 special speedloader"
	group = "Security"

/datum/supply_packs/c38sexammo
	name = ".38 special expensive speedloader"
	contains = list("/obj/item/ammo_magazine/c38s/ex",
					"/obj/item/ammo_magazine/ammobox/c38s/ex")
	cost = 60
	containertype = "/obj/structure/closet/crate"
	containername = ".38 special expensive speedloader"
	group = "Security"

/datum/supply_packs/fammo
	name = ".50 incendiary ammo"
	contains = list("/obj/item/ammo_magazine/ammobox/fbullet")
	cost = 30
	containertype = "/obj/structure/closet/crate"
	containername = ".50 incendiary ammo"
	group = "Security"

/datum/supply_packs/ninemmammo
	name = "9mm ammo"
	contains = list("/obj/item/ammo_magazine/c9mm_smithw_mag/empty",
					"/obj/item/ammo_magazine/c9mm_mac_mag/empty",
					"/obj/item/ammo_magazine/ammobox/c9mm")
	cost = 30
	containertype = "/obj/structure/closet/crate"
	containername = "9mm ammo"
	group = "Security"
...
/datum/supply_packs/Ivirus
	name = "Dangerous virus crate"
	contains = list("/obj/item/weapon/reagent_containers/glass/bottle/insanity")
	cost = 200
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Dangerous virus crate"
	access = ACCESS_CMO
	group = "Medical / Science"

/datum/supply_packs/armygi
	name = "Arcology GI crate"
	contains = list("/obj/item/weapon/gun/projectile/automatic/hamlet",
					"/obj/item/ammo_magazine/c45s",
					"/obj/item/clothing/shoes/db",
					"/obj/item/clothing/head/helmet/pasgt",
					"/obj/item/clothing/suit/armor/vestd",
					"/obj/item/clothing/under/tac")
	cost = 150
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Arcology GI crate"
	access = ACCESS_SECURITY
	group = "Security"

/datum/supply_packs/bazooka
	name = "Bazooka crate"
	contains = list("/obj/item/weapon/gun/projectile/bazooka",
					"/obj/item/ammo_magazine/rocket",
					"/obj/item/ammo_magazine/rocket",
					"/obj/item/ammo_magazine/rocket")
	cost = 100
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Bazooka crate"
	access = ACCESS_SECURITY
	group = "Security"

/datum/supply_packs/gauss
	name = "Gauss rifle crate"
	contains = list("/obj/item/weapon/gun/projectile/gauss",
					"/obj/item/ammo_magazine/mgauss")
	cost = 120
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Gauss rifle crate"
	access = ACCESS_SECURITY
	group = "Security"

/datum/supply_packs/garand
	name = "Garand M1 rifle crate"
	contains = list("/obj/item/weapon/gun/projectile/garand")
	cost = 90
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Garand M1 rifle crate"
	access = ACCESS_SECURITY
	group = "Security"

/datum/supply_packs/springfield
	name = "Springfield A7 rifle crate"
	contains = list("/obj/item/weapon/gun/projectile/springfield")
	cost = 70
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Springfield A7 rifle crate"
	access = ACCESS_SECURITY
	group = "Security"

/datum/supply_packs/garandammo
	name = "30-06 crate"
	contains = list("/obj/item/ammo_magazine/c30/empty",
					"/obj/item/ammo_magazine/strip_c30",
					"/obj/item/ammo_magazine/ammobox/c30")
	cost = 40
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "30-06 crate"
	access = ACCESS_SECURITY
	group = "Security"

/datum/supply_packs/vitacoins
	name = "Vitacoins crate"
	contains = list("/obj/item/weapon/vending_charge/vitacoin",
	...
	cost = 60
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Vitacoins crate"
	access = ACCESS_SECURITY
	group = "Security"

/datum/supply_packs/tools
	name = "Tools crate"
	contains = list("/obj/item/weapon/lhammer",
					"/obj/item/weapon/rasp",
					"/obj/item/weapon/screwdriver",
					"/obj/item/weapon/crowbar",
					"/obj/item/weapon/wirecutters",
					"/obj/item/device/multitool",
					"/obj/item/weapon/wrench",
					"/obj/item/weapon/CableCoil/random",
					"/obj/item/weapon/weldingtool")
	cost = 50
	containertype = "/obj/structure/closet/crate/secure/weapon"
	containername = "Tools crate"
	group = "Engineering"
...
/datum/supply_packs/minerasslt	//gemini
	name = "Miner assault gear"
	contains = list("/obj/item/clothing/under/rank/unit_d",
					...
					"/obj/item/weapon/hatchet",
					"/obj/item/ammo_magazine/c22",
					"/obj/item/weapon/storage/backpack/haversack",
					"/obj/item/weapon/gun/projectile/automatic/tommy")
	cost = 100
	containertype = "/obj/structure/closet/crate/secure"
	containername = "Miner assault gear crate"
	access = ACCESS_ENGINE
	group = "Engineering"
*/
/datum/supply_packs/minerdoubly	//gemini
	name = "5 Doubly gun pack"
	contains = list("/obj/item/weapon/gun/projectile/doubly",
					"/obj/item/weapon/gun/projectile/doubly",
					"/obj/item/weapon/gun/projectile/doubly",
					"/obj/item/weapon/gun/projectile/doubly",
					"/obj/item/weapon/gun/projectile/doubly",
					"/obj/item/ammo_magazine/c22")
	cost = 30
	containertype = "/obj/structure/closet/crate/secure"
	containername = "5 Doubly gun pack"
	access = ACCESS_ENGINE
	group = "Engineering"
