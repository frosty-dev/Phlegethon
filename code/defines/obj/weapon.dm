...
/obj/item/stack/medical/bruise_pack/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		heal_brute = roll("2d10")
	return
...
/obj/item/stack/medical/bruise_pack/craft/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		heal_brute = roll("1d10")
	return
...
/obj/item/stack/medical/ointment/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		heal_burn = roll("2d10")
	return
...
/obj/item/stack/medical/advanced/bruise_pack/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		heal_brute = roll("4d6")
	return
...
/obj/item/stack/medical/advanced/ointment/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		heal_burn = roll("4d6")
	return
...
/obj/item/weapon/cable_coil/random/New()
	fbyond_color = pick("red","yellow","green","blue","pink")
	icon_state = "coil_[fbyond_color]"
	..()
...
/obj/item/weapon/crowbar/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("2d6")
...
/obj/item/weapon/lpipe/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("2d6")
		throwforce = roll("2d10")
	return
...
/obj/item/weapon/lstick/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("1d10")
		throwforce = roll("1d6")
	return

/obj/item/weapon/bat	//phleg
	name = "bat"
	desc = "A wooden bat."
	icon_state = "bat"
	flags = FPRINT | TABLEPASS
...
/obj/item/weapon/bat/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("2d10")
		throwforce = roll("1d6")
	return

/obj/item/weapon/nbat	//phleg
	name = "nailed bat"
	desc = "A nailed bat. Looks dangerous"
	icon_state = "nbat"
	flags = FPRINT | TABLEPASS
	slot_flags = SLOT_BELT
	item_state = "c_tube"
...
/obj/item/weapon/nbat/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("4d6")
		throwforce = roll("1d6")
	return
...
/obj/item/weapon/extinguisher/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("4d6")
...
/obj/item/weapon/screwdriver/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("2d6")
		throwforce = roll("1d10")
	return
...
/obj/item/weapon/shard/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("3d6")
		throwforce = roll("3d10")
	return
...
/obj/item/weapon/kitchenknife/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("4d6")
		throwforce = roll("2d6")
	return
...
/obj/item/weapon/butch/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("6d6")
		throwforce = roll("3d6")
	return
...
/obj/item/weapon/kitchen/utensil/knife/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("4d6")
		throwforce = roll("2d10")
	return
...
/obj/item/weapon/scalpel/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("3d6")
		throwforce = roll("2d6")
	return

/obj/item/weapon/sharpening	//phleg
	name = "sharpening"
	...
	g_amt = 5000
	origin_tech = "materials=1"
	attack_verb = list("attacked", "stabbed", "torn", "ripped", "diced", "cut")

/obj/item/weapon/sharpening/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("3d10")
		throwforce = roll("2d6")
	return
...
/obj/item/weapon/surgicaldrill/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("3d10")
	return
...
/obj/item/weapon/circular_saw/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("3d10")
	return
...
/obj/item/weapon/hatchet/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("2d10")
		throwforce = roll("2d10")
	return

/obj/item/weapon/scout	//phleg
	name = "scout"
...
/obj/item/weapon/scout/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("3d6")
		throwforce = roll("4d10")
	return
...
/obj/item/weapon/craftknife	//phleg
...
/obj/item/weapon/craftknife/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("4d6")
	return

/obj/item/weapon/crafthatchet	//phleg
...
/obj/item/weapon/crafthatchet/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("2d15")
	return

/obj/item/weapon/craftspear	//phleg
	name = "makeshift spear"
	desc = "Let your inner huntsman go wild. You can either throw it or stab with it - both hurts badly."
	icon = 'weapons.dmi'
	icon_state = "hc_spear"
	flags = FPRINT | TABLEPASS | CONDUCT
	w_class = 2.0
...
/obj/item/weapon/craftspear/afterattack(atom/target as mob|obj|turf|area, mob/user as mob)
	if (user.equipped() == src)
		force = roll("2d15")
		throwforce = roll("4d8")
	return
...
/obj/item/weapon/flavor
	...
	fbyond_color = "beige" //Color the icon should take on when this is applied.  Also shown when it is mixed in.
...
///obj/item/weapon/attack(mob/M as mob, mob/user as mob)
