...
/obj/effect/sign/minerscape
	desc = "The marker of direction to escape shuttle"
	name = "escape arrow"
	icon = 'decals.dmi'
	icon_state = "minerscape"
	anchored = 1.0
	opacity = 0
	density = 0
...
/obj/structure/lattice/bullet_act(var/obj/item/projectile/Proj)
...
/obj/structure/cable
	...
	var/fbyond_color="red"
	var/cable_color = null
...
/obj/structure/shelf/up
	icon_state = "bookshelf1"

/obj/structure/shelf/mid
	icon_state = "bookshelf2"

/obj/structure/shelf/midbase
	icon_state = "bookshelf3"

/obj/structure/shelf/base
...
/obj/effect/mine/stun
	...
	name = "Bear trap"
	icon = 'weapons.dmi'
	icon_state = "beartraparmed"
	triggerproc = "triggerstun"

/*
	HasEntered(M as mob|obj)
		src.icon_state = "beartrap"
		armed = 0
		if(prob(30))
...
*/
	attack_hand()
		if(prob(70))
			...
			usr << "\blue You arming beartrap."
			sleep(50)
			usr << "\blue beartrap has been broken."
			new /obj/item/weapon/metalparts(src.loc)
			new /obj/item/weapon/metalparts(src.loc)
			new /obj/item/weapon/metalparts(src.loc)
			del(src)
...
/obj/effect/mine/frag
	...
	icon = 'weapons.dmi'
	icon_state = "fragmine"
	triggerproc = "triggerbrute"

/obj/effect/mine/booby
	name = "Booby trap"
	icon = 'ph_traps.dmi'
	icon_state = "booby"
	triggerproc = "triggerfrag"

/obj/effect/mine/booby/weak
	name = "Weak booby trap"
	icon = 'ph_traps.dmi'
	icon_state = "booby"
	triggerproc = "explode"

/obj/effect/mine/booby/molotov
	name = "Molotov trap"
	icon = 'ph_traps.dmi'
	icon_state = "booby"
	triggerproc = "triggermolotov"
...
/obj/structure/stool/bed/crvseat //phleg
	name = "bench"
	desc = "It bench."
	icon_state = "crvseat"

/obj/structure/crvstand
	density = 1
	name = "stand"
	desc = "It stand."
	icon = 'icons/obj/objects.dmi'
