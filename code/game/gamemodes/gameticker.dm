...
/datum/controller/gameticker/proc/pregame()
	login_music = pick('title1.ogg', 'title2.ogg', 'title3.ogg', 'title4.ogg', 'title5.ogg', 'title6.ogg') // choose title music!
...
/datum/controller/gameticker/proc/setup()
	...
	spawn(0)//Forking here so we dont have to wait for this to finish
		...
		spawn(-1)
			...
			world << sound(pick('welcome0.ogg','welcome1.ogg','welcome2.ogg','welcome3.ogg','welcome4.ogg','welcome5.ogg')) // Skie //phleg
