...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	new/datum/stack_recipe("metalparts", /obj/item/weapon/metalparts, one_per_turf = 1, on_floor = 1), \
	...
	new/datum/stack_recipe("hand-made crate", /obj/structure/closet/crate/handmadecrate, 20, one_per_turf=1, on_floor = 1,), \
	//new/datum/stack_recipe("wall console frame", /obj/item/frame/medicalconsole, 3, one_per_turf = 0, on_floor = 1), \//
	null, \
