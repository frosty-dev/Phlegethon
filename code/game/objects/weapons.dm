...
/obj/effect/mine/proc/triggerbrute(obj)
	if(ismob(obj))
		var/mob/M = obj
...
/obj/effect/mine/proc/triggermolotov(obj)
	var/datum/effect/effect/system/spark_spread/s = new /datum/effect/effect/system/spark_spread
	s.set_up(3, 1, src)
	s.start()
	spawn(0)
...
/obj/effect/mine/proc/triggerstun(obj)
	if(ismob(obj))
		var/mob/living/carbon/M = obj
		var/damage = roll("5d10")
		var/datum/organ/external/affecting = M.get_organ(pick("l_leg", "r_leg", "l_foot", "r_foot"))
...
/obj/effect/mine/frag/New()
	icon_state = "fragminearmed"

/obj/effect/mine/stun/New()
