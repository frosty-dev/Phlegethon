...
//phleg
/obj/item/weapon/implant/nanoaug/confess
	name = "Confess"
	desc = "Purifies the soul from sin. Quickly and efficiently."
	augment_text = "You feel sublimely..."
...
/obj/item/weapon/implanter/nanoaug/confess
	name = "Confess Implanter"

/obj/item/weapon/implanter/nanoaug/confess/New()
	src.imp = new /obj/item/weapon/implant/nanoaug/confess( src )
	..()
	update()
