...
/proc/get_access(job)
	switch(job)
		...
		if("Machinist")
			return list(ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_TECH_STORAGE, ACCESS_MAINT_TUNNELS, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_CONSTRUCTION, ACCESS_MINING, ACCESS_MINT, ACCESS_MINING_STATION)
		if("Convict")
		...
		if("Cargo Unit")
			return list(ACCESS_MAINT_TUNNELS, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_MAILSORTING, ACCESS_MINING, ACCESS_MINT, ACCESS_MINING_STATION, ACCESS_ARMORY)
		if("Unit")
			return list(ACCESS_MINING, ACCESS_MINT, ACCESS_MINING_STATION, ACCESS_MAINT_TUNNELS)
		if("Chief Engineer")
		...
		if("Research Director")
			return list(ACCESS_RD, ACCESS_HEADS, ACCESS_TOX, ACCESS_GENETICS,
			            ...
			            ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_TCOMSAT, ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_CHEMISTRY, ACCESS_HYDROPONICS)
	//	if("Virologist")
	//		return list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_VIROLOGY)
		if("Chief Medical Officer")
			...
			ACCESS_KEYCARD_AUTH, ACCESS_MAINT_TUNNELS, ACCESS_TOX_STORAGE, ACCESS_TOX, ACCESS_XENOBIOLOGY)
		if("Head of Nutrition")
			return list(ACCESS_HEADS, ACCESS_RC_ANNOUNCE, ACCESS_KITCHEN, ACCESS_KEYCARD_AUTH, ACCESS_MAINT_TUNNELS)
...
/proc/get_all_jobs()
	return list("Convict", "Captain", "Head of Personnel", "Overseer", "Bartender", "Chef", "Botanist", "Quartermaster", "Cargo Technician",
