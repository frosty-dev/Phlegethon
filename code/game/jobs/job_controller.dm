 ...
 **/
	proc/DivideOccupations()
		...
		Debug("DO, Running Convict Check 1")
		var/datum/job/assist = new /datum/job/assistant()
		var/list/assistant_candidates = FindOccupationCandidates(assist, 3)
		Debug("AC1, Candidates: [assistant_candidates.len]")
		for(var/mob/new_player/player in assistant_candidates)
			Debug("AC1 pass, Player: [player]")
			AssignRole(player, "Convict")
		...
		for(var/mob/new_player/player in unassigned)
			Debug("AC2 Convict located, Player: [player]")
			AssignRole(player, "Convict")
		return 1
	...
	//		H.equip_if_possible(new /obj/item/device/radio/headset(H), H.slot_ears)
		...
		if(H.mind && H.mind.assigned_role != "Cyborg" && H.mind.assigned_role != "AI" && H.mind.assigned_role != "Clown" && H.mind.assigned_role != "Convict")
