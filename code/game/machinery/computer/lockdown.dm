	...
	New()
		...
		switch(department)
			if("Engineering")
				...
				//
				//gemini
				connected_doors.Add("West port core access")
				connected_doors.Add("East port core access")
				connected_doors.Add("Vent Seal")
				connected_doors.Add("West Gyrotron room")
				connected_doors.Add("East Gyrotron room")
				connected_doors.Add("Plasma storage")
				connected_doors.Add("Primary injection")
				connected_doors.Add("Core Fuel Storage")
